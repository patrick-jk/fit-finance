...
public class InvestmentService {
    ...
    public Investment getBiggestInvestment(Long userId) {
        return investmentRepository.getBiggestInvestmentByUserId(userId)
                .orElseThrow(() -> new NotFoundException("Biggest investment not found"));
    }

    public Investment getSmallestInvestment(Long userId) {
        return investmentRepository.getSmallestInvestmentByUserId(userId)
                .orElseThrow(() -> new NotFoundException("Smallest investment not found"));
    }

    public InvestmentSummaryResponse getInvestmentSummary(Long userId) {
