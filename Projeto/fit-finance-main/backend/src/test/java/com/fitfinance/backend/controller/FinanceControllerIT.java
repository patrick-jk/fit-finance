...
import com.fitfinance.backend.config.TestRestTemplateConfig;
...
import com.fitfinance.backend.repository.FinanceRepository;
import com.fitfinance.backend.repository.TokenRepository;
import com.fitfinance.backend.repository.UserRepository;
...
import com.fitfinance.backend.util.FinanceUtils;
import com.fitfinance.backend.util.TokenUtils;
import com.fitfinance.backend.util.UserUtils;
import com.fitfinance.commons.response.AuthenticationResponse;
import com.fitfinance.commons.service.JwtService;
...
@ComponentScan(basePackages = {"com.fitfinance.authentication", "com.fitfinance.backend"})
@Log4j2
